...
- SwiftLint 版本: 0.62.2
- 当前配置: `.swiftlint.yml` (118 行)
- 违规分布:
  - Services + Core: 180 (66%)
  - Settings UI: 27 (10%)
  - LiveCaption: 20 (7%)
  - Components: 6 (2%)
  - Screenshot / QuickAsk: 0 (已清洁)
...
- 不修改 `.swiftlint.yml` 规则阈值（除非有合理理由）
- 不新增功能
- 不删除任何功能代码
- 不重构非违规代码
...
| 超时（任务量大） | 低 | 分 Phase 执行，可随时暂停 |

## Dependencies

- SwiftLint 0.62.2 (已安装)
- 无外部依赖
